...
dojo.ready(function () {
    dojo.declare("mobile.InfoWindow", [esri.InfoWindowBase], {
        constructor: function (parameters) {
            ...
            this._content.appendChild(dojo.byId('divDetailsInfo'));
            this._content.appendChild(dojo.byId('divCommentsInfo'));
            ...
            dojo.byId('divDetailsInfo').className = "";

            dojo.byId('divCommentsInfo').style.display = "none";
            dojo.byId('divCommentsInfo').className = "";
